...
uint32_t delta_decode(const uint8_t* input, uint32_t len, uint8_t* output, uint32_t output_max);
uint32_t delta_encode_16bit(const uint16_t* input, uint32_t len,
                             uint8_t* output, uint32_t output_max);  // FIX 3
uint32_t delta_decode_16bit(const uint8_t* input, uint32_t len, uint16_t* output, uint32_t output_max);

// Run-length encoding
uint32_t rle_encode(const uint8_t* input, uint32_t len,
                    uint8_t* output, uint32_t output_max);  // FIX 3
uint32_t rle_decode(const uint8_t* input, uint32_t len, uint8_t* output, uint32_t output_max);
...
uint32_t lz77_decode(const uint8_t* input, uint32_t len, uint8_t* output, uint32_t output_max);
