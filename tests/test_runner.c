...
void test_compression() {
    ...
    // Test Delta encoding
    uint32_t compressed_len = delta_encode(test_data, 100, compressed, sizeof(compressed));
    uint32_t decompressed_len = delta_decode(compressed, compressed_len, decompressed, sizeof(decompressed));
    ...
    uint32_t rle_compressed_len = rle_encode(rle_data, 100, compressed, sizeof(compressed));
    uint32_t rle_decompressed_len = rle_decode(compressed, rle_compressed_len, decompressed, sizeof(decompressed));
